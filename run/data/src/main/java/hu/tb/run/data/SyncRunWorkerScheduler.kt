...
import hu.tb.core.database.entity.DeletedRunSyncEntity
import hu.tb.core.database.entity.RunPendingSyncEntity
import hu.tb.core.database.mappers.toRunEntity
...
class SyncRunWorkerScheduler(
    ...
    override suspend fun scheduleSync(type: SyncRunScheduler.SyncType) {
        when (type) {
            ...
            is SyncRunScheduler.SyncType.FetchRuns -> scheduleFetchRunsWorkers(interval = type.interval)
        }
    }
